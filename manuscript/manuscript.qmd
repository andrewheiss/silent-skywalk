...
TODO: Cite @ChaudhryHeiss:2022


We use an experiment...

## Conjoint research design
...
TODO: More on conjoint stuff

Before launching the survey experiment, in an effort to avoid issues with p-hacking and cherry-picking results, we preregistered a series of confirmatory hypotehses at the Open Science Framework, and our preregistration protocol is available at URL. Appendix contains blah. Analysis fully reproducible using code and data available at BLAH
...
Marginal means and marginalization across a balanced reference grid
